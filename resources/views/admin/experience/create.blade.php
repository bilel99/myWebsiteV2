...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h2 class="page-title">Création expérience</h2>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    {!! Form::text('contrat', '', array('class'=>'form-control', 'name'=>'contrat', 'id'=>'contrat', 'placeholder' => 'Votre contrat',  'value'=>old('contrat'))) !!}
                                </div>
                            </div>
