...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h2 class="page-title">Edition Témoignage Id {{$temoignage->id}}</h2>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            {!! Form::open(['method' => 'put', 'url' => route('temoignage.update', $temoignage->id)]) !!}
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    {!! Form::select('langue_id', $langue, $temoignage->langue_id, ['class'=>'form-control']) !!}
                                </div>
                            </div>
